    ...
    let estimateValue: state => float = cState => {
      ...
      let rec colValue: list(string) => float =
        alos =>
          ...
          | [" ", " ", " ", "X", ...tl] => 
              1.0 +. colValue([" ", " ", "X", ...tl])
          | ["X", "O", "O", "O", ...tl] => 
              1.0 +. colValue(["O", "O", "O", ...tl])
          | [" ", "X", "O", "O", ...tl] => 
              1.0 +. colValue(["X", "O", "O", ...tl])
          | [" ", " ", "X", "O", ...tl] => 
              1.0 +. colValue([" ", "X", "O", ...tl])
          | [" ", " ", "X", "X", ...tl] => 
              8.0 +. colValue([" ", "X", "X", ...tl])
          | [" ", "X", "X", "O", ...tl] => 
              5.0 +. colValue(["X", "X", "O", ...tl])
          | ["X", "X", "O", "O", ...tl] => 
              4.0 +. colValue(["X", "O", "O", ...tl])
          | [" ", "X", "X", "X", ...tl] => 
              20.0 +. colValue(["X", "X", "X", ...tl])
          | ["X", "X", "X", "X", ..._] => 1000.0
          | [" ", " ", " ", "O", ...tl] => 
              -1.0 +. colValue([" ", " ", "O", ...tl])
          | ["O", "X", "X", "X", ...tl] => 
              -1.0 +. colValue(["X", "X", "X", ...tl])
          | [" ", "O", "X", "X", ...tl] => 
              -1.0 +. colValue(["O", "X", "X", ...tl])
          | [" ", " ", "O", "X", ...tl] => 
              -1.0 +. colValue([" ", "O", "X", ...tl])
          | [" ", " ", "O", "O", ...tl] =>
            (-8.0) +. colValue([" ", "O", "O", ...tl])
      ...
      let rec rowValue: list(string) => float =
        alos =>
          ...
          | ["X", "X", "X", "X", ..._] => 1000.0
          | [" ", "X", "X", "X", ...tl] => 
              50.0 +. rowValue(["X", "X", "X", ...tl])
          | ["X", "X", "X", " ", ...tl] => 
              50.0 +. rowValue(["X", "X", " ", ...tl])
          | ["O", "X", "X", "X", ...tl] => 
              15.0 +. rowValue(["X", "X", "X", ...tl])
          | ["X", "X", "X", "O", ...tl] => 
              15.0 +. rowValue(["X", "X", "O", ...tl])
          | [" ", "X", "X", " ", ...tl] => 
              10.0 +. rowValue(["X", "X", " ", ...tl])
          | ["X", "X", " ", " ", ...tl] => 
              10.0 +. rowValue(["X", " ", " ", ...tl])
          | [" ", " ", "X", "X", ...tl] => 
              10.0 +. rowValue([" ", "X", "X", ...tl])
